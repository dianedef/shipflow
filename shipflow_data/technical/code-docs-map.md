...
| `menu_gum.sh`, `menu_bash.sh` | Runtime CLI | `shipflow_data/technical/runtime-cli.md` | `shipflow_data/technical/context-function-tree.md` | `bash -n menu_gum.sh menu_bash.sh`; focused CLI smoke when behavior changes | Root menu layout, grouped submenu behavior, key handling, or visible CLI behavior changes |
