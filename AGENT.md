...
docs_impact: "yes"
linked_systems: ["CLAUDE.md", "CONTEXT.md", "CONTEXT-FUNCTION-TREE.md", "CONTENT_MAP.md", "README.md"]
depends_on: []
supersedes: []
evidence: ["Repository structure and active context docs", "CONTENT_MAP.md added as the content routing artifact"]
...
4. Lire `CONTENT_MAP.md` si la tache touche contenu, repurposing, blog, docs publiques, landing pages, FAQ ou cocons semantiques.
5. Lire `README.md` pour la vue d'ensemble publique et les workflows officiels.
