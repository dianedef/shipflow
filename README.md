...
Turso browser page displays a JWT/token, paste it back into the ShipFlow prompt;
ShipFlow sends it to the remote official CLI with `turso config set token` and
