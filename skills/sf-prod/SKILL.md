...
- Preserve deployment evidence, health check, log completeness, redaction, Sentry/PM2, Blacksmith, and preview handoff rules.
...
- `rg -n "Trace category|Process role|Chantier Potential|deploy|health|logs|Sentry|Blacksmith|redaction|references/" skills/sf-prod/SKILL.md`
